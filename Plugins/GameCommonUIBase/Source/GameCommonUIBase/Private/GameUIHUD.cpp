...
#include UE_INLINE_GENERATED_CPP_BY_NAME(GameUIHUD)
...
AGameUIHUD::AGameUIHUD(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	PrimaryActorTick.bStartWithTickEnabled = false;
}

void AGameUIHUD::PreInitializeComponents()
{
...
void AGameUIHUD::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
...
void AGameUIHUD::GetDebugActorList(TArray<AActor*>& InOutList)
{
