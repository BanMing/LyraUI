...
#include "Widgets/GameUIWidgetFactory_Class.h"

#include "Blueprint/UserWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(GameUIWidgetFactory_Class)

TSubclassOf<UUserWidget> UGameUIWidgetFactory_Class::FindWidgetClassForData_Implementation(const UObject* Data) const
{
