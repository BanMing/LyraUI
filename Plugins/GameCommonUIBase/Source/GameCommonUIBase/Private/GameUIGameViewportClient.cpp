...
#include "GameUIGameViewportClient.h"

#include "CommonUISettings.h"
#include "ICommonUIModule.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(GameUIGameViewportClient)
...
UGameUIGameViewportClient::UGameUIGameViewportClient()
	: Super(FObjectInitializer::Get())
{
}

void UGameUIGameViewportClient::Init(struct FWorldContext& WorldContext, UGameInstance* OwningGameInstance, bool bCreateNewAudioDevice)
{
