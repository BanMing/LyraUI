 ...
 */
UCLASS()
class GAMECOMMONUIBASE_API UUIExtensionPointWidget : public UDynamicEntryBoxBase
{
	GENERATED_BODY()
...
private:
	...
	void RegisterExtensionPointForPlayerState(UGameUILocalPlayer* LocalPlayer, APlayerState* PlayerState);
