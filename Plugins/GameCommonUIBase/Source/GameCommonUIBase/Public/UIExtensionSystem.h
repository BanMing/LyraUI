...
struct GAMECOMMONUIBASE_API FUIExtensionPointHandle
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct GAMECOMMONUIBASE_API FUIExtensionHandle
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class GAMECOMMONUIBASE_API UUIExtensionSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
...
UCLASS()
class GAMECOMMONUIBASE_API UUIExtensionHandleFunctions : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
UCLASS()
class GAMECOMMONUIBASE_API UUIExtensionPointHandleFunctions : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
