...
#include "GameUISimulatedInputWidget.generated.h"
 ...
 */
UCLASS(meta = (DisplayName = "GameUI Simulated Input Widget"))
class GAMECOMMONUIBASE_API UGameUISimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()

public:
	UGameUISimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
	...
	/**  */
	UFUNCTION(BlueprintCallable)
	const UInputAction* GetAssociatedAction() const
	{
	...
	UFUNCTION(BlueprintCallable)
	FKey GetSimulatedKey() const
	{
		return KeyToSimulate;
	}
