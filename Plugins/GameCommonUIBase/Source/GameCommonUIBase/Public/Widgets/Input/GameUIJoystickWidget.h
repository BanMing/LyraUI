...
#include "Widgets/Action/GameUIBoundActionButton.h"
#include "Widgets/Input/GameUISimulatedInputWidget.h"

#include "GameUIJoystickWidget.generated.h"
...
/**
 *  A UMG wrapper for the GameUI virtual joystick.
 *
 ...
 */
UCLASS(meta = (DisplayName = "GameUI Joystick"))
class GAMECOMMONUIBASE_API UGameUIJoystickWidget : public UGameUISimulatedInputWidget
{
	GENERATED_BODY()

public:
	UGameUIJoystickWidget(const FObjectInitializer& ObjectInitializer);
