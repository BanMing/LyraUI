...
private:
	UPROPERTY()
	TSubclassOf<UGameUIGameDialog> ConfirmationDialogClassPtr;

	UPROPERTY()
	TSubclassOf<UGameUIGameDialog> ErrorDialogClassPtr;

	UPROPERTY(config, EditAnywhere)
	TSoftClassPtr<UGameUIGameDialog> ConfirmationDialogClass;

	UPROPERTY(config, EditAnywhere)
	TSoftClassPtr<UGameUIGameDialog> ErrorDialogClass;
};
